...
//		System.out.println("(user2) AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = false     LDAP: error code 49 - comment: AcceptSecurityContext error, data 52e
		boolean isAuthenticate = adLdapProvider.authenticate("", "user2", "Qwerty1");
		System.out.println("(user2) AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = false     LDAP: error code 49 - comment: AcceptSecurityContext error, data 52e
...
//		System.out.println("(user1 in CN=Users2) AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = false     LDAP: error code 32 - problem 2001 (NO_OBJECT)
		isAuthenticate = adLdapProvider.authenticate("OU=Users,OU=People,OU=HO", "user1", "Qwerty1");
		System.out.println("(user1 in OU=Users,OU=People,OU=HO) AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = false     LDAP: error code 32 - problem 2001 (NO_OBJECT)
...
//		System.out.println("(user1 in " + ADLdapConfig.BASE_USERDIR + ") AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = true
		isAuthenticate = adLdapProvider.authenticate(ADLdapConfig2.BASE_USERDIR, "user1", "Qwerty1");
		System.out.println("(user1 in " + ADLdapConfig2.BASE_USERDIR + ") AUTHENTICATE: " + isAuthenticate); //TODO:  authenticate = true
...
//			for (ADLdap group : adLdapProvider.findGroups("user1", ADLdapConfig.BASE_USERDIR)) System.out.println(group.getCn());
			for (ADLdap group : adLdapProvider.findGroups("user1", ADLdapConfig2.BASE_USERDIR)) System.out.println(group.getCn());
...
//			for (ADLdap group : adLdapProvider.findGroups("user2", ADLdapConfig.BASE_USERDIR, ADLdapConfig.ROLE_NAMES2)) System.out.println(group.getCn());
			...
			System.out.println("\n5.2) * Search Group(s) by UserName=user1 in OU=Ctsprog:\n----------------");
//			for (ADLdap group : adLdapProvider.findGroups("user2", ADLdapConfig.BASE_USERDIR, ADLdapConfig.ROLE_NAMES1)) System.out.println(group.getCn());
			for (ADLdap group : adLdapProvider.findGroups("user1", ADLdapConfig2.BASE_USERDIR, ADLdapConfig2.ROLE_NAMES1)) System.out.println(group.getCn());
...
//			for (ADLdap group : adLdapProvider.findGroups("user4", ADLdapConfig2.BASE_USERDIR, ADLdapConfig2.ROLE_NAMES1)) System.out.println(group.getCn());
		}
		System.out.println("|||||||||||||||||||||||||||");
